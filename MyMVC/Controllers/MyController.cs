...
//        [HttpGet, Route("FileIndex/{id}")]
//        public ActionResult FileIndex(int id)
//        {

//            string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, $"images/{id}.png");
...
//        public ActionResult PutIndex(string id, Student model)
//        {
//            return Content($"{id} -- {model.Id} -- {model.Name}");
//        }
